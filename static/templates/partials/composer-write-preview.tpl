<div class="write-preview-container d-flex gap-2 flex-grow-1 overflow-auto">
	<div class="write-container d-flex d-md-flex w-50 position-relative">
		...
		<textarea class="write shadow-none rounded-1 w-100 form-control overscroll-behavior-contain" placeholder="[[modules:composer.textarea.placeholder]]">{body}</textarea>
	</div>
